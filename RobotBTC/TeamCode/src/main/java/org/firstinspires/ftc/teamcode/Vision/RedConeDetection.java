...
public class RedConeDetection extends OpenCvPipeline {
    ...
    public static Scalar scalarLowerYCrCb = new Scalar(0.0, 200.0, 20.0);
    ...
    public RedConeDetection(double borderLeftX, double borderRightX, double borderTopY, double borderBottomY) {
